...
class OnlyFisch {
	 ...
	 *
	 * We're doing this through a filter instead of simply pasting it
	 * into the header.php to stay within WordPress standards
	 *
	 * @since 2.0
	 * @return void
	 */
	function wp_head() {
		...
		<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/js/ie8.js"></script>
		<![endif]-->
		<?php
	}
