 ...
 * @package OnlyFischintheSea
 *
 */

class OnlyFischintheSea {
	...
	function wp_enqueue_scripts() {
		wp_enqueue_script( 'onlyfischinthesea', 	 get_stylesheet_directory_uri() . '/js/onlyfischinthesea.js', array( 'jquery' ), OFITS_VERSION, true );
	}
	...
	function wp_enqueue_styles() {
		wp_enqueue_style( 'app-css', get_stylesheet_directory_uri() . '/css/onlyfischinthesea.css' );
	}
	...
	function customize_register ( $wp_customize ) {
		...
		$wp_customize->add_section (
			'onlyfischinthesea_logo', array(
				'title' 	=> __('Site Logo', 'onlyfischinthesea'),
				'priority' 	=> 80,
			)
		);

		$wp_customize->add_setting (
			'onlyfischinthesea_theme_options[logo_upload]', array(
		...
		$wp_customize->add_control (
			new WP_Customize_Image_Control( $wp_customize, 'logo_upload', array (
				'label'		=> __('Site Logo', 'onlyfischinthesea'),
				'section' 	=> 'onlyfischinthesea_logo',
				'settings' 	=> 'onlyfischinthesea_theme_options[logo_upload]',
